...
namespace ncorr {     
    class Image2D; // Forward declare class if not already done
    
    // Add this forward declaration with the default argument:
    void imshow(const Image2D& img, std::ptrdiff_t delay = -1); 
